...
class ProductLainnyaAdapter(private var data: List<Keripik>,
                            private var listener: (Keripik) -> Unit) : RecyclerView.Adapter<ProductLainnyaAdapter.LeagueViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): LeagueViewHolder {
        ...
        val inflateView: View = layoutInflater.inflate(R.layout.product_lainnya_item, parent, false)
